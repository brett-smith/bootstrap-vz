...
class AbstractPartition(FSMProxy, metaclass=ABCMeta):
    ...
    def _before_format(self, e):
        ...
        command = [part.format(**variables) for part in format_command]
    ...
    def _after_mount(self, e):
        ...
        for destination in sorted(iter(self.mounts.keys()), key=len):
    ...
    def _before_unmount(self, e):
        ...
        for destination in sorted(iter(self.mounts.keys()), key=len, reverse=True):
